...
// IMPORTANTE: Configuración actualizada con tus datos de EmailJS
const EMAILJS_CONFIG = {
    serviceId: 'service_wsitxod',          // Esto es un ejemplo - usa tu Service ID real
    templateId: 'template-arbuz1218039607', // Tu Template ID correcto
    publicKey: 'R381QsKgvbWdj9tI-'       // Tu Public Key (correcta)
};
    ...
    contactForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const templateParams = {
                ...
                to_email: 'franlydev@gmail.com'  // Correo actualizado
            };
            ...
            console.log('EmailJS Response:', response); // Para depuración
            ...
            formMessage.innerHTML = `
                ...
                <p class="text-sm mt-1">${error.message || 'Por favor, verifica tu configuración de EmailJS o intenta de nuevo más tarde.'}</p>
            `;
            formMessage.classList.remove('hidden');
        ...
        input.addEventListener('blur', function () {
            if (this.value.trim()) {
                ...
                if (errorElement) {
                    ...
                    this.classList.add('border-light-gray/30');
                }
            }
        });

        // Also validate on input for email field
        if (input.id === 'email') {
